...
/******/ 			var chunk = require("./" + ({"1":"components/v-card","2":"components/v-header","3":"components/v-overlay","4":"components/v-speaker","5":"components/v-worker","6":"pages/index"}[chunkId]||chunkId) + ".js");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
___CSS_LOADER_EXPORT___.push([module.i, "@import url(https://fonts.googleapis.com/css2?family=Nunito:wght@200;300;400;500;600;700;800;900;1000&display=swap);"]);
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*,*::before,*::after{box-sizing:border-box}ul[class],ol[class],ul,ol{padding:0;margin:0}button{padding:0;border:0;background-color:rgba(0,0,0,0)}body,h1,h2,h3,h4,p,ul[class],ol[class],li,figure,figcaption,blockquote,dl,dd{margin:0;list-style-type:none;padding:0}body{font-family:\"FuturaBT-Book\";min-height:100vh;scroll-behavior:smooth;text-rendering:optimizeSpeed;line-height:1.5;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:text}ul[class],ol[class]{list-style:none}a:not([class]){text-decoration-skip-ink:auto}img{display:block}.outline_red{border:1px solid;border-color:red}article>*+*{margin-top:1em}@media(prefers-reduced-motion: reduce){*{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important;scroll-behavior:auto !important}}.devOutline{outline-color:red;outline-width:1px;outline-style:inset}a{text-decoration:none;color:#000}@font-face{font-family:\"Nunito\";src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");font-style:normal;font-weight:400}body{font-family:\"Nunito\",sans-serif;background:#f8f8f8}.container{padding:0px 16px;margin:0 auto}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
module.exports = __webpack_require__.p + "fonts/Nunito-VariableFont_wght.4a3eef3.ttf";
...
__webpack_require__.d(components_namespaceObject, "VCard", function() { return VCard; });
__webpack_require__.d(components_namespaceObject, "VHeader", function() { return VHeader; });
__webpack_require__.d(components_namespaceObject, "VOverlay", function() { return VOverlay; });
__webpack_require__.d(components_namespaceObject, "VSpeaker", function() { return VSpeaker; });
__webpack_require__.d(components_namespaceObject, "VWorker", function() { return VWorker; });
...
const _7b3af69a = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 6).then(__webpack_require__.bind(null, 51)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(25), 'users.js');
...
const VCard = () => __webpack_require__.e(/* import() | components/v-card */ 1).then(__webpack_require__.bind(null, 28)).then(c => wrapFunctional(c.default || c));
const VHeader = () => __webpack_require__.e(/* import() | components/v-header */ 2).then(__webpack_require__.bind(null, 47)).then(c => wrapFunctional(c.default || c));
const VOverlay = () => __webpack_require__.e(/* import() | components/v-overlay */ 3).then(__webpack_require__.bind(null, 48)).then(c => wrapFunctional(c.default || c));
const VSpeaker = () => __webpack_require__.e(/* import() | components/v-speaker */ 4).then(__webpack_require__.bind(null, 50)).then(c => wrapFunctional(c.default || c));
const VWorker = () => __webpack_require__.e(/* import() | components/v-worker */ 5).then(__webpack_require__.bind(null, 49)).then(c => wrapFunctional(c.default || c));
